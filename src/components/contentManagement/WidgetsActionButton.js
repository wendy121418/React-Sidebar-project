        ...
        <div>
            <div className="dropdown" style={{ float: "right" }}>
                  ...
                  <div className="dropdown-content ">
                    ...
                    <Link to="#" ><div className="flex"><div className="pr-2 flex items-center"><ImIcons.ImBin size={15}/></div><div>Remove Item</div></div></Link>
                  </div>
                </div>
        </div>
    )
...
export default WidgetsActionButton
